...
static WeiboAPIClient *_sharedClient = nil;
static dispatch_once_t onceToken;

+ (WeiboAPIClient *)sharedJsonClient {
    dispatch_once(&onceToken, ^{
        _sharedClient = [[WeiboAPIClient alloc] initWithBaseURL:[NSURL URLWithString:[NSObject baseURLStr]]];
    });
